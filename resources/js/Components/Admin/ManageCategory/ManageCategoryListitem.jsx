...
export default function ManageCategoryListitem({ dataCategory }) {
    const { id, article_type } = dataCategory;
    const {
        data,
        setData,
        patch,
        ...
        category_name: dataCategory.article_type,
    });
